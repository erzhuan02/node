...
// console.log(__dirname);
// console.log(__dirname + '../data/test/aa.txt');//E:\陈转\11阶段 Node\02\04-代码.1../data/test/aa.txt   ../不会自动处理
// console.log(__dirname + 'data/test/aa.txt'); //E:\陈转\11阶段 Node\02\04-代码.1data/test/aa.txt /也要加，
